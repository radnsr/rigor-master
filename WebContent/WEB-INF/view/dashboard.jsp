...
<body layout="row" ng-controller="AppCtrl">
	...
	<div layout="column" class="relative" layout-fill role="main">
		...
		<md-button  aria-label href="http://localhost:8080/RigorProject/user"> <ng-md-icon
		...
		<h3>Feedback Form</h3>
			 ...
			 <md-grid-tile class="green" ng-if="user_role=='Administrator' || user_role== 'Manager'">
		<md-button  aria-label href="http://localhost:8080/RigorProject/feedback_list"> <ng-md-icon
			icon="supervisor_account" style="fill: pink" size="100"></ng-md-icon>
		</md-button> <md-grid-tile-footer>
		<h3>Feedback List</h3>
		</md-grid-tile-footer> </md-grid-tile> 
