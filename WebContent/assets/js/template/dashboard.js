...
App.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
  ...
  $scope.showListBottomSheet = function($event) {
    ...
    $mdBottomSheet.show({
     ...
     // alert (clickedItem.link);
      if(clickedItem.icon=='sign'){
    	window.location.href='http://localhost:8080/RigorProject/logout/';
      }
    });
  };
...
App.controller('ListBottomSheetCtrl', function($scope, $mdBottomSheet) {
  $scope.items = [
    ...
    { name: 'Sign out', icon: 'sign', link:'http://localhost:8080/RigorProject/user' },
  ];
...
App.config(function($mdThemingProvider) {
  var customBlueMap = 		$mdThemingProvider.extendPalette('cyan', {
